...
<div class="header">
	<div class="logo">
		<a href="index.php">Innovative Attendance System</a>
	</div>
</div>
<?php  
  if (isset($_GET['error'])) {
...
<div class="topnav" id="myTopnav">
	...
	<a href="Send_feedback.php">Feedback</a>
    ...
    <div class="modal-content">
      ...
      <form action="ac_update.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	      	...
	      	<input type="password" name="up_pwd" placeholder="Enter Admin Password..." required/><br>
	      </div>
